...
class TranslateController extends \craft\web\Controller {
	...
	public function actionIndex(){
		...
		/*$translateRecord = TranslateRecord::findOne(['id'=>41]);
		$fields = json_decode($translateRecord->fields,true);

		$entry = Entry::findOne(1059);
		BuddyPlugin::getInstance()->translate
			->translateEntry(
				...
				$fields,
				41,
				'do not translate HTML code, link URLs or filenames that can break the functionality of the link or code'
			);
exit();*/
	...
	public function actionLog(){
		...
		return $this->renderTemplate('convergine-contentbuddy/translate/_log',
			[
				...
				'translationSection'=>Craft::$app->sections->getSectionById($translationRecord->sectionId)->name,
