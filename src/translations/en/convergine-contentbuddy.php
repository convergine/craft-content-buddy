<?php return [
	...
	'assistantDescription'=>'Choose the OpenAI Assistant from your account that is specifically configured for translations. This assistant should include clear instructions for handling translation tasks, including any glossaries, preferred terminology, and localization guidelines. For best results, make sure the selected assistant is optimized for your content type and target languages.',
	'Save your OpenAI access token before selecting an Assistant.'=>'Save your OpenAI access token before selecting an Assistant.',
    'xAiModelDescription' => 'For more information and a list of current models, see https://docs.x.ai/developers/models',
	'xAiReasoningEffortDescription' => 'How much reasoning grok-4.3 should apply. "none" disables reasoning and is the cheapest option; "low" is the xAI default. Ignored by other models.',
	'anthropicModelDescription' => 'For more information and a list of current models, see https://platform.claude.com/docs/en/about-claude/models/overview',
	'openRouterModelDescription' =>'For more information and a list of current models, see https://openrouter.ai/models',
	'openRouterSaveKeyDescription' =>'Save API key, to get all available models',
	...
	'imageOpenai5ModelDescription' => 'Select the default model that will be used when generating an image using OpenAI GPT-5 . For more information, see https://platform.openai.com/docs/models',
	'imageOpenRouterDescription' => 'Select the default model that will be used when generating an image using OpenRoute. For more information, see https://openrouter.ai/models',
	...
	'Translate Content Block Fields'=>'Translate Content Block Fields',
	'translateContentBlockFieldsText'=>'Translate all Content Block fields content, recursively',
	...
	/* Import/Export */
	'General Content Buddy Settings'=>'General Content Buddy Settings',
	...
	'Download the current settings and prompts as json file'=>'Download the current settings and prompts as json file',
	'Upload a settings json file to import settings and/or prompts'=>'Upload a settings json file to import settings and/or prompts',
	'Please backup your database before attempting to import settings.<br>Import operation will overwrite all Content Buddy settings from imported file'=>'Please backup your database before attempting to import settings.<br>Import operation will overwrite all Content Buddy settings from imported file'
];
